...
2. List the available hunks:
   ...
   ${CLAUDE_PLUGIN_ROOT}/skills/stage-hunk/scripts/stage_hunk.py --list-hunks --staged "$FILE"
   ```
...
4. Call the script with the hunk numbers from the list (plain integers, space-separated):
   ```
   ${CLAUDE_PLUGIN_ROOT}/skills/stage-hunk/scripts/stage_hunk.py "$FILE" 2
   ${CLAUDE_PLUGIN_ROOT}/skills/stage-hunk/scripts/stage_hunk.py "$FILE" 1 3 5
   ${CLAUDE_PLUGIN_ROOT}/skills/stage-hunk/scripts/stage_hunk.py --unstage "$FILE" 1
   ```
