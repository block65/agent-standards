...
Every classification — stage _and_ skip — must be a conclusion drawn from looking at the diff and the surrounding code, not a reflex driven by what the hunk superficially looks like. "I haven't looked yet" is never a verdict: default-to-skip turns the tool into a no-op, default-to-stage turns it into a hazard.
